...
// 🐱🐶🤖 Cat / Dog / Ask
import { catCommand, dogCommand, askCommand } from './commands/fun/catdogask.js';
...
client.commands.set(dogCommand.name, dogCommand);
client.commands.set(askCommand.name, askCommand);
