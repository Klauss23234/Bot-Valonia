...
// 📚 Forum Help
import forumHelpCommand from './commands/forum-help.js';

// ⚠️ Warn
import warnCommand, { handleWarnButtons } from './commands/warn.js';
...
// 📚 Forum Help
client.commands.set(forumHelpCommand.name, forumHelpCommand);
...
client.on('interactionCreate', async interaction => {
  ...
  // 💡 Suggestions (bouton + modal + votes + admin)
  ...
  try { await handleTicketButtons(interaction); } catch {}
  try { await handleCandidature(interaction); } catch {}
  try { await handleWarnButtons(interaction); } catch {}
