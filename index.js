...
// ✅ ACTIVATION DE L'ÉVÉNEMENT (AJOUT IMPORTANT)
if (welcomeEvent) {
  client?.on?.('dummy', () => {}); // sécurité si jamais (évite erreur avant init)

  // On attend que client soit défini juste après
}
