...
export async function handleTicketButtons(interaction) {
  ...
  if (interaction.isModalSubmit() && interaction.customId === 'ticket_reason_modal') {
    ...
    try {
      ...
      const welcomeEmbed = new EmbedBuilder()
        ...
        .setImage('https://i.imgur.com/4M34hi2.png')  // bannière décorative (remplaçable)
        .setFooter({
      ...
      // Ligne 2 : gestion membres + fermeture (accessible au propriétaire ET au staff)
  ...
  // ── Fermer le ticket ──
  // ✅ MODIFIÉ : le propriétaire du ticket peut aussi fermer son propre ticket
