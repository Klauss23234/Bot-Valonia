...
const STAFF_ROLE_ID    = '1489722611297685514';       // 👈 ID du rôle staff
  ...
  async execute(message, args) {
    ...
    if (sub === 'claim') {
      ...
      await message.channel.send({ embeds: [new EmbedBuilder()
        .setDescription(`📌 Ce ticket a été **claim** par ${message.member} — c'est lui qui gère ta demande !`)
        .setColor('#5865F2')
        .setTimestamp()
      ]});
